...
# BARRA LATERAL: VIGENCIA Y CARGA DE EXCEL
...
st.sidebar.markdown("---")
st.sidebar.header("📁 Base de Datos Excel / CSV")
...
# Histórico completo base inicial (incluyendo 2026 y 2027)
...
# PROCESAMIENTO DEL ARCHIVO EXCEL/CSV SUBIDO
